...
public class CardModel {
    ...
    public CardModel(int id, String  front, String back, Boolean favourite, LocalDateTime createdAt, List<String> hashtags,String collection_title, String username) {
        this.id = id;
        this.front = front;
        this.back = back;
        this.favourite = favourite;
